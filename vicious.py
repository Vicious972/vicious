###########################################
#	This Script Is Code By Vicious    #
...
print("      Code By Vicious. -2019/8/2")
print("       Last Update In 2020/5/27")
...
def main():
	...
	if cho =='y':
		rsp = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=socks4&timeout=1000&country=all') #Code By Vicious
